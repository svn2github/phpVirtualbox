...
'Execution Cap' => 'Execution Cap', /*new*/
'%s%' => '%s%', /*new*/
...
'Choose existing disk' => 'Choose existing disk', 
'You are about to add a new CD/DVD drive to controller %s.' => 'You are about to add a new CD/DVD drive to controller %s.',
'Would you like to choose a virtual CD/DVD disk to put in the drive or leave it empty for now?' => 'Would you like to choose a virtual CD/DVD disk to put in the drive or leave it empty for now?',
'Choose disk' => 'Choose disk',
'Leave empty' => 'Leave empty',
'You are about to add a new floppy drive to controller %s.' => 'You are about to add a new floppy drive to controller %s.',
'Would you like to choose a virtual floppy disk to put in the drive or leave it empty for now?' => 'Would you like to choose a virtual floppy disk to put in the drive or leave it empty for now?',
...
'Normal' => 'Normal',/*new*/
'Writethrough' => 'Writethrough',/*new*/
'Immutable' => 'Immutable',/*new*/
'Actions' => 'Actions',
'Remove' => 'Remove',
'Release' => 'Release',
...
'Current machine state desc' => 'If you select <b>Current machine state</b>, only the current state of the virtual machine is cloned.',/*new*/
'Current machine and all child states' => 'Current machine and all child states',/*new*/
'Current machine and all child states desc' => 'If you select <b>Current machine and all child states</b> the current state of the virtual machine and any states of child snapshots are cloned.',/*new*/
'All states' => 'All states',/*new*/
'All states desc' => 'If you select <b>All states</b>, the current machine state and all snapshots are cloned.',/*new*/
...
'newDisk Step2 Message1' => 'Please choose whether the new virtual disk file should be allocated as it is used or if it should be created fully allocated.', /*new*/
'newDisk Step2 dynamic' => 'A <b>dynamically allocated</b> virtual disk file will only use space on your physical hard disk as it fills up, although it will not shrink again automatically when space on it is freed.', /*new*/
...
'Storage Type' => 'Storage Type',/*removed*/
'Storage details' => 'Storage details',/*new*/
'Dynamically allocated' => 'Dynamically allocated',/*new*/
'Dynamically expanding storage' => 'Dynamically expanding storage',/*removed*/
'Fixed size' => 'Fixed size',/*new*/
'Fixed-size storage' => 'Fixed size storage',/*removed*/
'Virtual Disk Location and Size' => 'Virtual Disk Location and Size',/*removed*/
...
'newDisk Step4 Message2' => 'If the above settings are correct, press the <b>Finish</b> button. Once you press it, a new hard disk will be created.',
